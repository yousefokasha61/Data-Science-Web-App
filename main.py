...
DATA_URL = ("/home/yousef/Documents/web app/Motor_Vehicle_Collisions_-_Crashes.csv")
...
st.header("Top 5 streets by number of affected people in each category")
select = st.selectbox('Categories of affected people', ['Pedestrians', 'Cyclists', 'Motorists'])
